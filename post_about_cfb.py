...
from query.get_games import get_games, post_a_days_games # TODO: move the posting function
...
def post_about_cfb(date: datetime, username: str, login_type: str | None = "dev"):
    ...
    games = get_games(date=date, db_session=db_session, client=client)  # TODO: this shouldn't post at all
