...
class TestESPNParser:
    def test_get_scoring_plays_missed_pat(self, game_with_missed_pat):
        ...
        assert plays[0]["play_text"] == "Jackson Arnold run for 1 yd for a TD (Tyler Keltner KICK)"
        ...
        assert plays[3]["play_text"] == "Ty Thompson pass complete to Reggie Brown for 7 yds for a TD (Ethan Head PAT MISSED)"
